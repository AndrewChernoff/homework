...
const HW6 = () => {
    ...
    const restore = () => {
        // делают студенты
        let oldValue = restoreState('hw6-editable-span-value', localStorage.getItem('hw6-editable-span-value'))
        ...
        <div id={'hw6'}>
            ...
            <div className={s2.hw}>
                ...
                <div className={s.buttonsContainer}>
                    <SuperButton id={'hw6-save'} onClick={save} className={s.hw6_save_btn}>
                        Save to ls
                    </SuperButton>
                    <SuperButton
                        id={'hw6-restore'}
